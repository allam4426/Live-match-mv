export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-foreground">
      ...
      <p className="mb-8 text-sm text-muted-foreground">Last updated: August 22, 2026</p>

      <p className="mb-8 text-muted-foreground leading-relaxed">
        Please read these terms and conditions carefully before using Our Service.
      </p>

      <h2 className="text-xl font-bold mb-3">Interpretation and Definitions</h2>
      ...
      <p className="mb-3 text-muted-foreground leading-relaxed">For the purposes of these Terms and Conditions:</p>
      <ul className="list-disc list-inside mb-8 text-muted-foreground leading-relaxed space-y-2">
        <li><strong className="text-foreground">Affiliate</strong> means an entity that controls, is controlled by, or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
        <li><strong className="text-foreground">Country/State</strong> refers to: Maldives</li>
        <li><strong className="text-foreground">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to Livematchmv.</li>
        ...
        <li><strong className="text-foreground">Terms and Conditions</strong> (also referred to as "Terms") means these Terms and Conditions, including any documents expressly incorporated by reference, which govern Your access to and use of the Service and form the entire agreement between You and the Company regarding the Service.</li>
        <li><strong className="text-foreground">Third-Party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third party that is displayed, included, made available, or linked to through the Service.</li>
        <li><strong className="text-foreground">Website</strong> refers to Livematchmv, accessible from <a href="https://www.livematchmv.online/more" className="text-primary underline" target="_blank" rel="noopener noreferrer">https://www.livematchmv.online/more</a></li>
      ...
      <h3 className="text-lg font-bold mb-2">Links from a Third-Party Social Media Service</h3>
      <p className="mb-4 text-muted-foreground leading-relaxed">
      ...
      <h2 className="text-xl font-bold mb-3">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
      <p className="mb-4 text-muted-foreground leading-relaxed">
      ...
      <h2 className="text-xl font-bold mb-3">Disputes Resolution</h2>
      <p className="mb-8 text-muted-foreground leading-relaxed">
        If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
      </p>

      <h2 className="text-xl font-bold mb-3">For European Union (EU) Users</h2>
      <p className="mb-8 text-muted-foreground leading-relaxed">
        If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.
      </p>

      <h2 className="text-xl font-bold mb-3">United States Legal Compliance</h2>
      <p className="mb-8 text-muted-foreground leading-relaxed">
        You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.
      </p>

      <h2 className="text-xl font-bold mb-3">Severability and Waiver</h2>
      <h3 className="text-lg font-bold mb-2">Severability</h3>
      <p className="mb-4 text-muted-foreground leading-relaxed">
        If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
      </p>
      <h3 className="text-lg font-bold mb-2">Waiver</h3>
      <p className="mb-8 text-muted-foreground leading-relaxed">
        Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.
      </p>

      <h2 className="text-xl font-bold mb-3">Translation Interpretation</h2>
      <p className="mb-8 text-muted-foreground leading-relaxed">
        These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.
      </p>

      <h2 className="text-xl font-bold mb-3">Changes to These Terms and Conditions</h2>
      <p className="mb-4 text-muted-foreground leading-relaxed">
      ...
      <ul className="list-disc list-inside text-muted-foreground leading-relaxed space-y-1">
        <li>By email: info@livematchmv.online</li>
      </ul>
    </div>
  );
}
