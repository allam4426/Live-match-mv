...
export const AddSquadPlayerBody = zod.object({
  ...
  "playerName": zod.string(),
  "playerCode": zod.string().optional(),
...
export const GetSquadPlayerStatsResponse = zod.object({
  ...
  "tournamentStats": zod.array(zod.object({
  "tournamentId": zod.number().nullable(),
  "tournamentName": zod.string(),
  "tournamentLogo": zod.string().nullish(),
...
export const ListTournamentsResponseItem = zod.object({
  ...
  "color": zod.string().nullish().describe('Hex color for tournament branding (e.g. #e53935)'),
